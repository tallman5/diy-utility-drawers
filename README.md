...
1. **Assembly Instructions:** Instructions will guide you through the process of assembling the footer, frames and drawers. The current version of the assembly instructions can be found [here](assembly-instructions.md).
